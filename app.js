...
const RECOMMENDATIONS = [
  {
    ...
    nna: {
      psych: [
        { icon: '📝', text: 'Escribe o dibuja cómo te sientes ahora mismo — así podrás recordarlo cuando lleguen las nubes grises (Kuypers, 2011)' },
        { icon: '🌬️', text: 'Practica la respiración cuadrada: 4 segundos entro, 4 aguanto, 4 suelto — es como entrenar antes del partido (Siegel & Bryson, 2012)' },
        { icon: '🔍', text: '¿Qué está haciendo que hoy estés bien? Anótalo — ese es tu "mapa personal de la calma"' },
      ],
      sensory: [
        { icon: '🎵', text: 'Crea tu playlist de calma ahora que estás bien — la música que sabes que te regula cuando las cosas se ponen difíciles (Wilbarger & Wilbarger, 1991)' },
        { icon: '🏃', text: 'Haz 15 minutos de movimiento intenso cada día: saltar, columpiarse, correr, nadar — es como cargar la batería sensorial (Ayres, 1972)' },
        { icon: '🧸', text: 'Explora qué texturas te calman y guárdalas en un kit — piedra lisa, tela suave, arcilla, pelota antiestrés — tu kit de regulación sensorial (Wilbarger & Wilbarger, 1991)' },
      ],
    },
    school: {
      psych: [
        { icon: '🧩', text: 'Ofrecer retos intelectuales reales y difíciles — el cerebro AACC necesita desafíos auténticos para mantenerse en zona de calma (Webb et al., 2016)' },
        { icon: '📅', text: 'Anticipar todos los cambios de horario o rutina con tiempo — avisar siempre, cambiar nunca sin previo aviso (Kuypers, 2011)' },
        { icon: '🗣️', text: 'Usar lenguaje directo y literal: "Haz X porque Y pasará" — sin sarcasmo ni dobles sentidos. El cerebro autista entiende causa-efecto (Gray, 1994)' },
      ],
      sensory: [
        { icon: '🪑', text: 'Permitir cojines de movimiento o bandas elásticas en la pata de la silla — el movimiento no es distracción, es regulación sensorial activa (Ayres, 1972)' },
        { icon: '⏰', text: 'Anunciar transiciones 5 minutos antes con aviso visual y verbal: "En 5 minutos cambiamos a matemáticas" — la predictibilidad regula el sistema nervioso (Wilbarger, 1991)' },
        { icon: '🔇', text: 'Identificar y reducir fuentes de ruido innecesarias del aula: silla que chirría, ventilador, ruido de pasillos (Gere et al., 2009)' },
      ],
    },
    family: {
      psych: [
        { icon: '🗺️', text: 'Crear juntos el "mapa de la calma": qué situaciones, rutinas y personas le hacen sentir bien — usarlo como guía preventiva (Kuypers, 2011)' },
        { icon: '🔄', text: 'Mantener la rutina diaria con horarios predecibles — la predictibilidad es el mejor antídoto contra la desregulación en AACC + TEA (Silverman, 2002)' },
        { icon: '💛', text: 'Pasar tiempo de calidad en sus intereses especiales sin presión — la conexión emocional en calma es la mejor vacuna (Neihart et al., 2002)' },
      ],
      sensory: [
        { icon: '🏠', text: 'Diseñar juntos un kit sensorial domiciliar: auriculares, objetos táctiles, manta pesada, aromas favoritos — tenerlo listo ANTES de necesitarlo (Wilbarger & Wilbarger, 1991)' },
        { icon: '🚶', text: 'Planificar 15 minutos diarios de "trabajo pesado" en casa: jardinería, cargar bolsas, empujar muebles, nadar, trepar — esto organiza el sistema sensorial (Ayres, 1972)' },
...

  {
    ...
    nna: {
      psych: [
        { icon: '🔤', text: 'Pon nombre exacto a lo que sientes: ¿ruido? ¿aburrimiento? ¿injusticia? Nombrar la emoción la hace más pequeña — el cerebro funciona mejor cuando sabe qué pasa (Kuypers, 2011)' },
        { icon: '🗣️', text: 'Usa tu palabra-señal con el adulto de confianza — puede ser cualquier palabra, como "ámbar" — eso avisa sin tener que explicar todo (Gray, 1994)' },
        { icon: '⏸️', text: 'Pide un descanso de 5 minutos antes de que sea urgente — puedes decir exactamente esto: "Necesito un momento"' },
      ],
      sensory: [
        { icon: '🎧', text: 'Ponte los auriculares anti-ruido o pon tu música de calma — el sonido correcto cambia el estado del sistema nervioso (Wilbarger & Wilbarger, 1991)' },
        { icon: '✋', text: 'Aprieta fuerte algo con las manos durante 10 segundos y suelta — el input propioceptivo dice al cuerpo "estás seguro/a" (Ayres, 1972)' },
    ...
    school: {
      psych: [
        { icon: '✅', text: 'Hacer check-in breve con el adulto de confianza: una pregunta, sin presión, sin grupo — "¿Estás bien?" con opción de señal de mano (Kuypers, 2011)' },
        ...
        { icon: '⏳', text: 'Reducir la presión de tiempo en las tareas — la urgencia temporal es un factor de sobrecarga especialmente alto en AACC + TEA (Webb et al., 2016)' },
      ],
      sensory: [
        { icon: '🌅', text: 'Reducir estímulos del aula: bajar persianas, bajar el volumen, pedir al resto que use voz interior — menos input sensorial = más espacio cerebral (Gere et al., 2009)' },
        { icon: '🚶', text: 'Ofrecer 2 minutos de movimiento: "¿Quieres dar una vuelta al pasillo?" — el movimiento propioceptivo es regulador, no premio (Ayres, 1972)' },
        { icon: '🧊', text: 'Tener disponible una caja de herramientas sensoriales accesible: pop-it, pelota antiestrés, fidget spinner — el alumno/a elige sin preguntar (Wilbarger, 1991)' },
      ],
    },
    family: {
      psych: [
        { icon: '💬', text: 'Validar sin minimizar: "Tiene sentido que eso te moleste" — nunca decir "no es para tanto" — la validación baja la intensidad emocional (Siegel & Bryson, 2012)' },
        { icon: '🛋️', text: 'Tener una rutina de descompresión en casa al llegar del colegio: silencio, su espacio, sin preguntas durante los primeros 20 minutos (Daniels & Piechowski, 2009)' },
      ...
      sensory: [
        { icon: '🍎', text: 'Ofrecer un snack crujiente o masticable: zanahoria, manzana, chicle, fruta seca — la masticación da input propioceptivo y regula (Ayres, 1972)' },
        { icon: '💧', text: 'Hacer UNA actividad de la dieta sensorial: 10 min de baile, empujar una pared, nadar, columpiarse — planificada, no improvisada (Wilbarger & Wilbarger, 1991)' },
...

  {
    ...
    nna: {
      psych: [
        { icon: '🛑', text: 'PARA lo que estás haciendo y di en voz alta o escrito: "Hay demasiado de ___" — nombrar activa el córtex prefrontal y baja la alarma (Siegel & Bryson, 2012)' },
        { icon: '🌬️', text: 'Respiración cuadrada: 4 entro, 4 aguanto, 4 suelto, 4 espero — repite 4 veces seguidas — esto activa el sistema nervioso parasimpático (Linehan, 1993)' },
        { icon: '🏠', text: 'Ve a tu espacio seguro — ese lugar donde no tienes que explicar nada ni responder a nadie — el espacio físico regula el sistema nervioso (Kuypers, 2011)' },
      ],
      sensory: [
        { icon: '💪', text: 'Haz trabajo pesado AHORA: empuja una pared 30 segundos, haz flexiones de pared, aprieta un cojín con toda tu fuerza — los músculos necesitan presión (Ayres, 1972)' },
        { icon: '🛌', text: 'Métete bajo la manta pesada o el saco de dormir — la presión profunda dice al sistema nervioso "estás seguro/a" y baja la activación (Wilbarger & Wilbarger, 1991)' },
        { icon: '🎧', text: 'Auriculares con música de calma o ruido blanco — bloquear el sonido del entorno reduce la carga sensorial inmediatamente (Wilbarger, 1991)' },
      ],
    },
    school: {
      psych: [
        { icon: '🚪', text: 'Acompañar al alumno/a a la sala de calma SIN reproches, SIN explicaciones, SIN tono de castigo — la retirada previene la crisis (Kuypers, 2011)' },
        { icon: '🗣️', text: 'Usar frases cortísimas: "Vamos a la sala tranquila", "Estás seguro/a" — el cerebro sobrecargado no puede procesar instrucciones largas (Siegel & Bryson, 2012)' },
        { icon: '☑️', text: 'Ofrecer solo 2 opciones concretas: "¿Sala de calma o pasillo?" — el cerebro sobrecargado no puede elegir entre muchas opciones (Gray, 1994)' },
      ],
      sensory: [
        { icon: '🏠', text: 'Vaciar el entorno: retirar otros alumnos, cerrar la puerta, bajar luces, apagar sonidos — menos inputs = más velocidad de recuperación (Gere et al., 2009)' },
        { icon: '🧘', text: 'Ofrecer manta pesada, cojín de presión o lap pad en la sala de calma — dejar al alumno/a elegir la posición (suelo, silla, rincón) sin corregirla (Wilbarger, 1991)' },
        { icon: '🪨', text: 'Proporcionar input propioceptivo de alta intensidad: bandas de resistencia, push-ups de pared, apretar arcilla — el cuerpo necesita trabajar para calmarse (Ayres, 1972)' },
      ],
    },
    family: {
      psych: [
        { icon: '😤', text: 'Regúlate tú primero: baja tus hombros, respira despacio, baja la voz — tu sistema nervioso regula directamente el suyo (Siegel & Bryson, 2012)' },
        { icon: '💬', text: 'Valida ANTES de resolver: "Veo que estás muy agobiado/a. Tiene todo el sentido." — espera 5 minutos antes de buscar soluciones (Linehan, 1993)' },
      ...
      sensory: [
        { icon: '🚿', text: 'Ofrecer una ducha o baño caliente — el agua, la temperatura y la presión del chorro son reguladores sensoriales muy potentes (Ayres, 1972)' },
        { icon: '🤲', text: 'Presión firme en hombros o espalda si el niño/a lo acepta — preguntar primero: "¿Puedo darte un abrazo fuerte?" (Wilbarger & Wilbarger, 1991)' },
...

  {
    ...
    nna: {
      ...
      sensory: [
        { icon: '💥', text: 'Movimiento muy intenso durante 2 minutos: corre en sitio, salta fuerte, empuja con toda tu fuerza — el cuerpo necesita descargar la energía sensorial acumulada (Ayres, 1972)' },
        { icon: '🛌', text: 'Presión máxima: manta pesada encima, envolverse apretado en una manta, saco de dormir — la contención profunda baja la activación del sistema nervioso (Wilbarger, 1991)' },
    ...
    school: {
      psych: [
        { icon: '🚶', text: 'Retirada inmediata del aula — pocas palabras, sin negociación, sin reproches: "Vamos" — la acción es más útil que el discurso ahora (Kuypers, 2011)' },
        { icon: '🤐', text: 'Presencia silenciosa del adulto — no intentar razonar, no explicar, no preguntar — el cerebro no puede procesar nada de eso en este momento (Siegel & Bryson, 2012)' },
      ...
      sensory: [
        { icon: '🌑', text: 'Sala de calma con iluminación mínima o apagada, sin ruidos, sin objetos nuevos — solo el espacio vacío y un adulto tranquilo (Gere et al., 2009)' },
        { icon: '🛡️', text: 'Ofrecer únicamente los objetos sensoriales que el alumno/a ya conoce y le funcionan — no introducir estímulos nuevos en este momento (Wilbarger, 1991)' },
        { icon: '🧘', text: 'Permitir cualquier posición corporal: suelo, debajo de la mesa, en rincón — el cuerpo busca la posición que más input propioceptivo le da (Ayres, 1972)' },
      ],
    },
    family: {
      psych: [
        { icon: '😤', text: 'Regúlate tú primero — respira hondo, baja los hombros — tu calma es la herramienta más potente que tienes ahora mismo (Siegel & Bryson, 2012)' },
      ...
      sensory: [
        { icon: '🛏️', text: 'Preparar un "nido": habitación oscura y silenciosa, manta pesada, temperatura fresca — el sistema nervioso necesita mínima estimulación y máxima contención (Wilbarger, 1991)' },
        { icon: '🌡️', text: 'Temperatura como regulador: paño frío en frente si hay mucho calor, o baño caliente si tiembla — el contraste térmico activa el nervio vago (Ayres, 1972)' },
...

  {
    ...
    nna: {
      psych: [
        { icon: '💛', text: 'Esto siempre termina. Siempre. No estás roto/a — tu cerebro está haciendo lo que sabe hacer cuando hay demasiado (Neihart et al., 2002)' },
      ...
      sensory: [
        { icon: '🏃', text: 'Si puedes moverte con seguridad, ve a un espacio grande y vacío — el espacio físico amplio reduce la sobrecarga sensorial (Ayres, 1972)' },
        { icon: '🧊', text: 'Agua muy fría en la cara o hielo en las manos — el frío intenso activa el reflejo de buceo y baja el ritmo cardíaco muy rápido (Linehan, 1993 — TIP skill)' },
        { icon: '🤲', text: 'Si aceptas: presión muy firme (abrazo apretado, manta pesada) — si no: nada de contacto físico — respetar el límite sensorial siempre (Wilbarger, 1991)' },
      ],
    },
    school: {
      psych: [
        { icon: '🛡️', text: 'Seguridad primero: retirar objetos peligrosos, dar espacio físico grande, llamar a un segundo adulto (Kuypers, 2011)' },
        ...
        { icon: '📋', text: 'Documentar exactamente qué desencadenó la crisis — esa información es necesaria para el plan de prevención con la familia (Siegel & Bryson, 2012)' },
      ],
      sensory: [
        { icon: '🏠', text: 'Sala de emergencia: lo más vacía posible, mínima luz, puerta con acceso visual del adulto — el espacio vació es el mayor regulador sensorial (Gere et al., 2009)' },
        { icon: '🚫', text: 'Sin herramientas sensoriales nuevas — solo lo que el alumno/a ya conoce como calmante — los estímulos desconocidos pueden empeorar (Wilbarger, 1991)' },
    ...
    family: {
      psych: [
        { icon: '💨', text: 'Respira tú primero — tu sistema nervioso habla al suyo sin palabras — si tú te activas, él/ella se activa más (Siegel & Bryson, 2012)' },
      ...
      sensory: [
        { icon: '🌊', text: 'Reset sensorial con agua: ducha fría o baño caliente según lo que el niño/a tolera — el agua es el regulador sensorial más potente y accesible (Ayres, 1972)' },
        { icon: '⏳', text: 'El volcán puede durar entre 20 minutos y 2 horas — no lo puedes parar, pero sí contenerlo — presencia tranquila sin demandas es lo mejor (Wilbarger, 1991)' },
        { icon: '🏥', text: 'Si las crisis con componente sensorial son frecuentes, solicitar evaluación de integración sensorial con terapeuta ocupacional especializado en TEA (Ayres, 1972)' },
      ],
    },
  },
];
